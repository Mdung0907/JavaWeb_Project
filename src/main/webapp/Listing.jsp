...
<button class="btncreate" style="margin-left: 7%" data-bs-toggle="modal" data-bs-target="#exampleModal">Tạo sản phẩm mới</button>
	<div class="recent-listing" style="margin-top: 0">
		<div class="container">
			<div class="row">
			<c:forEach var="product" items="${f:getAllproductbyAccount(AccountLogin.getId())}">
				<div class="col-lg-12">
									...
									<div class="listing-item">
										...
										<div class="right-content align-self-center" style="padding: 0;margin-left: 30px">
											...
											<span class="price"><div class="icon">
												...
												</div> ${product.getGia()}</span> <span class="details">Details:
												<em>2760 sq ft</em>
											</span>
											<ul class="info">
											...
											<div class="main-white-button">
												<a href="Contact.jsp"><i class="fa fa-eye"></i> Chỉnh sửa</a>
											</div>
										</div>
									</div>
								</div>
