...
<body>
	...
	<main class="main-banner ">
		...
		<section id="main-section"
			class="main-section container-full mx-auto d-flex">
			<section class="product-selected w-100 d-flex">
				<div class="product-preview">
					<div class="product-presentation d-flex">
						<div
							...
							<img src="https://i.ibb.co/C9hkdD7/sofa.png"
				...
				<div class="product-description">
					<div class="product-summary-container">
						<h1 class="product-type">Three-Seat Sofa</h1>
						<p class="product-text-description">
							Highly durable full-grain leather which is soft and has a natural
							look and feel. <a href="#">View More</a>
						</p>
					</div>
