              ...
              <div class="col-lg-6 align-self-center">
                <form id="contact" action="" method="get">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <ul>
                        <li><input type="checkbox" name="option1" value="Xe cộ"><span>Xe cộ</span></li>
                        <li><input type="checkbox" name="option2" value="aparmtents"><span>Căn hộs</span></li>
                        <li><input type="checkbox" name="option3" value="Mua sắm"><span>Mua sắm</span></li>
                        <li><input type="checkbox" name="option4" value="Ẩm thực"><span>Ẩm thực &amp; Đời sống</span></li>
                        <li><input type="checkbox" name="option5" value="Du lịch"><span>Du lịch</span></li>
                      </ul>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
